...
//	private static final Log log = LogFactory.getLog("showapi.log");
	...
	public static void  logCommError(Exception e,  String urlStr, String appId,String bodyContent) {
		DateFormat df = new SimpleDateFormat(com.example.familiycookmenu.utils.Constants.DATE_TIME_FORMAT);
		df.setTimeZone(TimeZone.getTimeZone(com.example.familiycookmenu.utils.Constants.DATE_TIMEZONE));
		String rspCode = "";
		StringBuilder sb = new StringBuilder();
